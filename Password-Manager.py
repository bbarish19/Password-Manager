...
# Load the secret key from the file (auto-generate if it doesn't exist)
def load_key():
...
88888888888888888888888888888888888888888888888888888888888888888888888""", font=("Helvetica", 12), anchor='center')
    ...
    # Instead of calling mainloop here, we let the main application loop manage the windows.
...
def run():
    ...
    if not check_eula_signed():
        show_eula_popup(root, lambda: PasswordManagerApp(root))
    else:
